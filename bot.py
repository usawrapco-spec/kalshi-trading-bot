...
class KalshiBot:
    ...
    def _initialize_strategies(self):
        ...
        if Config.ENABLE_ARBITRAGE:
            self.strategies.append(ArbitrageStrategy(self.client, self.risk_manager, self.db))
            logger.info("✅ Arbitrage strategy enabled")
        
        if Config.ENABLE_MOMENTUM:
            self.strategies.append(MomentumStrategy(self.client, self.risk_manager, self.db))
