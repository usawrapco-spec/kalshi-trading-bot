...
CONTRACTS = 1
MAX_POSITIONS = 10
MAX_BUYS_PER_WINDOW = 10      # max NEW positions per 15-min round
ROUND_BUDGET_PCT = 0.50       # spend max 50% of STARTING_BALANCE per round (hard cap, no reinvesting wins)
